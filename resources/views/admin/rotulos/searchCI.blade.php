...
@section('content')
    ...
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-table"></i>Rotulos<br><small>En esta sección puede ver todos los rotulos registrados por  {{ $user[0]->name }} {{ $user[0]->app }} {{ $user[0]->apm }}</small>
            </h1>
        </div>
    </div>
